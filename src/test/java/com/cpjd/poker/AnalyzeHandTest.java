...
public class AnalyzeHandTest {
    ...
    public void analyzeHand() {
        ...
        ArrayList<Card> flush = cards(card(Suit.SPADES, Number.THREE), card(Suit.SPADES, Number.FOUR), card(Suit.SPADES, Number.FIVE), card(Suit.SPADES, Number.TEN), card(Suit.SPADES, Number.SEVEN));
        ArrayList<Card> straight = cards(card(Suit.HEARTS, Number.THREE), card(Suit.SPADES, Number.FOUR), card(Suit.SPADES, Number.FIVE), card(Suit.SPADES, Number.SIX), card(Suit.SPADES, Number.SEVEN));
        ArrayList<Card> threeOfAKind = cards(card(Suit.DIAMONDS, Number.SIX), card(Suit.SPADES, Number.FOUR), card(Suit.SPADES, Number.SIX), card(Suit.SPADES, Number.SIX), card(Suit.SPADES, Number.SEVEN));
        ArrayList<Card> twoPairs = cards(card(Suit.SPADES, Number.THREE), card(Suit.SPADES, Number.THREE), card(Suit.CLUBS, Number.FIVE), card(Suit.SPADES, Number.SIX), card(Suit.SPADES, Number.FIVE));
        ArrayList<Card> onePair = cards(card(Suit.SPADES, Number.THREE), card(Suit.CLUBS, Number.FOUR), card(Suit.SPADES, Number.FIVE), card(Suit.SPADES, Number.THREE), card(Suit.SPADES, Number.SEVEN));
        ArrayList<Card> noPair = cards(card(Suit.SPADES, Number.THREE), card(Suit.SPADES, Number.FOUR), card(Suit.CLUBS, Number.FIVE), card(Suit.SPADES, Number.SIX), card(Suit.SPADES, Number.QUEEN));
        ...
        assertEquals(new HandValue(fourOfAKind, HandValue.Category.FOUR_OF_A_KIND), new AnalyzeHand(null).analyzeHand(fourOfAKind));
        assertEquals(new HandValue(fullHouse, HandValue.Category.FULL_HOUSE), new AnalyzeHand(null).analyzeHand(fullHouse));
        assertEquals(new HandValue(flush, HandValue.Category.FLUSH), new AnalyzeHand(null).analyzeHand(flush));
        assertEquals(new HandValue(straight, HandValue.Category.STRAIGHT), new AnalyzeHand(null).analyzeHand(straight));
        assertEquals(new HandValue(threeOfAKind, HandValue.Category.THREE_OF_A_KIND), new AnalyzeHand(null).analyzeHand(threeOfAKind));
        assertEquals(new HandValue(twoPairs, HandValue.Category.TWO_PAIR), new AnalyzeHand(null).analyzeHand(twoPairs));
        assertEquals(new HandValue(onePair, HandValue.Category.PAIR), new AnalyzeHand(null).analyzeHand(onePair));
        assertEquals(new HandValue(noPair, HandValue.Category.HIGH_CARD), new AnalyzeHand(null).analyzeHand(noPair));
    }
    ...
    public void isStraightFlush() {
        ...
        ArrayList<Card> case5 = cards(card(Suit.HEARTS, Number.ACE), card(Suit.HEARTS, Number.TWO), card(Suit.HEARTS, Number.THREE), card(Suit.HEARTS, Number.FIVE));
    ...
    public void ascending() {
        ...
        ArrayList<Card> case2 = cards(card(Suit.SPADES, Number.SIX), card(Suit.SPADES, Number.TWO), card(Suit.SPADES, Number.THREE));
        ArrayList<Card> case3 = cards(card(Suit.SPADES, Number.KING), card(Suit.SPADES, Number.QUEEN), card(Suit.SPADES, Number.ACE));
        ...
        assertTrue(new AnalyzeHand(null).ascending(case5));

        assertFalse(new AnalyzeHand(null).ascending(case2));
